...
SECTIONS {
        ...
        .stack: block(0x20000) fill=0xbeef {
            GBL_stackbeg = .;
            *(.stack)
            GBL_stackend = (GBL_stackbeg + 0x5000 - 1) ;
        ...
        .dsm: block(0x20000) {} > SARAM
        
       /* RTA_fromHost buffer */
       .hst1: block(0x20000) align = 0x4 {} > SARAM
        
       /* RTA_toHost buffer */
       .hst0: block(0x20000) align = 0x4 {} > SARAM
